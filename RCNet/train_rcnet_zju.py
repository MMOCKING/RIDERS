...
class Config:
    def __init__(self):
        ...
        self.root = '/media/lh/lh1/dataset/ZJU-Multispectrum'
        self.train_scenes = ['2023-10-19-19-25-47',
        ...
        self.checkpoint_dirpath = \
            os.path.join('/media/lh/lh1/dataset/ZJU-Multispectrum/log/rcnet',current_time)
        ...
        # Input settings
        self.batch_size = 4
        self.patch_size = [240, 100]
        self.total_points_sampled = 30
