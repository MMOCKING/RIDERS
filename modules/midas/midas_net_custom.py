...
class MidasNet_small_depth(BaseModel):
    """Network for monocular depth estimation.
    """

    def __init__(self, device='cpu', path=None, features=64, backbone="efficientnet_lite3", non_negative=False,
                 exportable=True, channels_last=False, align_corners=True,
                 blocks={'expand': True}, in_channels=2, regress='r', min_pred=None, max_pred=None):
        """Init.
        ...
        super(MidasNet_small_depth, self).__init__()
