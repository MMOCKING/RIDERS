...
scenes = [scene for scene in scenes if scene.startswith('2023')]
# scenes = ['2023-10-20-10-07-22']

image_file = 'thermal_undistort'
radar_file = 'radar_png'
gt_file = 'lidar_png_int'
output_path = '/media/lh/lh1/dataset/ZJU-Multispectrum/output/rcnet_0.1'

restore_path = '/media/lh/lh1/dataset/ZJU-Multispectrum/log/rcnet/best/model-528000.pth'
patch_size = [240, 100]
    ...
    for paths in inputs_outputs:
        ...
        for sample_idx, data in enumerate(dataloader):
            with torch.no_grad():
                ...
                radar_pts_cnt += radar_points.shape[1]
                bounding_boxes_list = []
        ...
        print('radar pts per frame: {:.4f}'.format(radar_pts_cnt/n_run_sample))
